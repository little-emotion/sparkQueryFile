...
public class Config {
  ...
  // for read
  public String FILE_PATH = "data/tdrive/1";
...
//    public String KAIROSDB_URL = "http://192.168.10.64:1408";
  ...
  // for query
  public boolean IS_WITH_VALUE_FILE = false;
...
//    public long END_TIME = 1946816515000L;
  ...
  private void load(Properties properties) {
    ...
    IS_WITH_VALUE_FILE = Boolean.parseBoolean(properties.getOrDefault("IS_WITH_VALUE_FILE", IS_WITH_VALUE_FILE).toString());
